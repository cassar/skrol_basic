...
class CalculateSTSTest < ActiveSupport::TestCase
  test 'compile_sts works as advertised' do
    ...
    result = compile_sts(target_sentence, base_script)
    assert_equal(0.27463707450582453, result.entry, 'incorrect score returned')
  ...
  test 'calculate_sts works as advertised' do
    ...
    assert_equal(0.27463707450582453, result, 'incorrect sts score returned')
  end
  ...
  test 'return_sentence_scores works as advertised' do
    ...
    template = [0.16556689244189246, 0.0, 0.6666666666666667]
